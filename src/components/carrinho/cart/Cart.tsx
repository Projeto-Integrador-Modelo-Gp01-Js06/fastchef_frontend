	...
	return (
		<>
			...
			>
				...
				{quantidadeItems > 0 && (
					<div className="container mx-auto my-8 py-4 w-[60vw] grid grid-cols-2 dark:text-black border rounded-lg bg-white text-lg">
          ...
          hover:bg-[#44b063] w-1/2 py-2 mx-auto flex justify-center my-4"
								type="submit"
